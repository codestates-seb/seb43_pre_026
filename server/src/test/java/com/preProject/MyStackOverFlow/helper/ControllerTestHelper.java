...
public interface ControllerTestHelper<T> {
    ...
    default RequestBuilder putRequestBuilder(String url, long resourceId, String content) {
        return put(url, resourceId)
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content(content);
    }

    default RequestBuilder putRequestBuilder(String uri, String content) {
        return put(uri)
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content(content);
